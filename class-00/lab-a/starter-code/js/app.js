...
function displayPics(){
  ...
  // rando is only scoped to be used in the displayPics() function code block and can not be used outside of it.
  console.log(viewed);
...
function handleClick(event) {
  ...
  // let allProductsLocalStorage = JSON.parse(localStorage.busmall);
  // for (let i = 0; i < allProductsLocalStorage.length; i++) {
  //   allProducts.push(allProductsLocalStorage[i]);
  // }
